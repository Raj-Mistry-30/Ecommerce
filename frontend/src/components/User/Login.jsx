                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-center py-10 px-4 sm:px-14">
                            ...
                            <form onSubmit={handleLogin}>
                                <div className="flex flex-col w-full gap-4">
                                    ...
                                    <div className="flex flex-col gap-2.5 mt-2 mb-32">
                                        <p className="text-xs text-primary-grey text-left">By continuing, you agree to <a href="https://www.flipkart.com/pages/terms" className="text-primary-green"> Terms of Use</a> and <a href="https://www.flipkart.com/pages/privacypolicy" className="text-primary-green"> Privacy Policy.</a></p>
                                        <button type="submit" className="text-white py-3 w-full bg-primary-green shadow hover:shadow-lg rounded-sm font-medium">Login</button>
                            ...
                            <Link to="/register" className="font-medium text-sm text-primary-green">New User? Create an account</Link>
                        </div>
                        {/* <!-- edit info container --> */}
