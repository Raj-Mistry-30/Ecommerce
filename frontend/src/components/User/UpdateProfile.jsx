            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="loginSidebar bg-primary-green px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                        <h1 className="font-medium text-white text-3xl">My Profile Update!</h1>
                        <p className="text-gray-200 text-lg pr-2"></p>
                    </div>
                    {/* <!-- sidebar column  --> */}
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-primary-green shadow rounded-sm font-medium hover:shadow-lg">Update</button>
